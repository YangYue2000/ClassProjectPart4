...
sources = $(wildcard $(SOURCEDIR)/**/StatusCode.java $(SOURCEDIR)/**/DBConf.java $(SOURCEDIR)/**/models/AlgebraicOperator.java $(SOURCEDIR)/**/models/AttributeType.java $(SOURCEDIR)/**/models/AssignmentOperator.java $(SOURCEDIR)/**/models/AssignmentExpression.java $(SOURCEDIR)/**/models/ComparisonOperator.java $(SOURCEDIR)/**/models/ComparisonPredicate.java $(SOURCEDIR)/**/models/IndexType.java $(SOURCEDIR)/**/models/IndexRecord.java $(SOURCEDIR)/**/models/NonClusteredBPTreeIndexRecord.java $(SOURCEDIR)/**/models/NonClusteredHashIndexRecord.java $(SOURCEDIR)/**/models/Record.java $(SOURCEDIR)/**/models/TableMetadata.java $(SOURCEDIR)/**/fdb/FDBKVPair.java $(SOURCEDIR)/**/fdb/FDBHelper.java $(SOURCEDIR)/**/utils/*.java $(SOURCEDIR)/**/TableMetadataTransformer.java $(SOURCEDIR)/**/TableManager.java $(SOURCEDIR)/**/TableManagerImpl.java $(SOURCEDIR)/**/RecordsTransformer.java $(SOURCEDIR)/**/IndexTransformer.java $(SOURCEDIR)/**/Cursor.java $(SOURCEDIR)/**/Records.java $(SOURCEDIR)/**/RecordsImpl.java $(SOURCEDIR)/**/Indexes.java $(SOURCEDIR)/**/IndexesImpl.java $(SOURCEDIR)/**/Iterator.java $(SOURCEDIR)/**/SelectIterator.java $(SOURCEDIR)/**/JoinIterator.java $(SOURCEDIR)/**/RelationalAlgebraOperators.java $(SOURCEDIR)/**/RelationalAlgebraOperatorsImpl.java $(SOURCEDIR)/**/test/*.java)
